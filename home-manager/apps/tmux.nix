...
{
  config = lib.mkIf (config.sn.os == "darwin") {
    programs.tmux = {
      enable = true;
      clock24 = true;
      keyMode = "vi";
      ...
      # TODO directly import from nixos config somehow
      # TODO add history-limit to shared config
      ...
      extraConfig = ''
        ...
        # Ensure NIX_PATH changes are propagated
