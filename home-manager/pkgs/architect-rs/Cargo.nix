    ...
    crates = {
      ...
      "architect-rs" = rec {
        ...
        src = lib.cleanSourceWith {
          filter = sourceFilter;
          src = ../../../../../../../../media/software/source/rust-cargo2nix-projects/architect-rs;
        };
        authors = [
      ...
      "attohttpc" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            target =
              { target, features }:
              (!((target."os" == "windows") || (target."os" == "macos") || (target."os" == "ios")));
          }
          {
            name = "url";
            packageId = "url";
        ...
        dependencies = [
          {
            ...
            target =
              { target, features }:
              (((target."arch" == "x86_64") || (target."arch" == "aarch64")) && (target."os" == "hermit"));
          }
          {
            name = "libc";
            packageId = "libc";
