...
let
  sources = {
    ...
    "acorn-6.0.1" = {
      ...
      version = "6.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/acorn/-/acorn-6.0.1.tgz";
        sha512 = "SiwgrRuRD2D1R6qjwwoopKcCTkmmIWjy1M15Wv+Nk/7VUsBad4P8GOPft2t6coDZG0TuR5dq9o1v0g8wo7F6+A==";
      };
    };
    "acorn-globals-4.3.0" = {
      name = "acorn-globals";
    ...
    "acorn-walk-6.0.1" = {
      ...
      src = fetchurl {
        ...
        sha512 = "PqVQ8c6a3kyqdsUZlC7nljp3FFuxipBRHKu+7C1h8QygBFlzTaDX5HD383jej3Peed+1aDG8HwkfB1Z1HMNPkw==";
      };
    };
    "ajv-5.5.2" = {
      name = "ajv";
    ...
    "data-urls-1.0.1" = {
      ...
      src = fetchurl {
        ...
        sha512 = "0HdcMZzK6ubMUnsMmQmG0AcLQPvbvb47R0+7CCZQCYgcd8OUWG91CG7sM6GoXgjz+WLl4ArFzHtBMy/QqSF4eg==";
      };
    };
    ...
    "node-abi-2.4.4" = {
      ...
      version = "2.4.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/node-abi/-/node-abi-2.4.4.tgz";
        sha512 = "DQ9Mo2mf/XectC+s6+grPPRQ1Z9gI3ZbrGv6nyXRkjwT3HrE0xvtvrfnH7YHYBLgC/KLadg+h3XHnhZw1sv88A==";
      };
    };
    "noop-logger-0.1.1" = {
      name = "noop-logger";
    ...
    "prebuild-install-5.1.0" = {
      ...
      version = "5.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/prebuild-install/-/prebuild-install-5.1.0.tgz";
        sha512 = "jGdh2Ws5OUCvBm+aQ/je7hgOBfLIFcgnF9DZ1PIEvht0JKfMwn3Gy0MPHL16JcAUI6tu7LX0D3VxmvMm1XZwAw==";
      };
    };
    "prelude-ls-1.1.2" = {
      name = "prelude-ls";
    ...
    "tree-sitter-0.13.15" = {
      ...
      version = "0.13.15";
      src = fetchurl {
        url = "https://registry.npmjs.org/tree-sitter/-/tree-sitter-0.13.15.tgz";
        sha512 = "FuvU+csO7t/rQqLdL3+w4Jg+4Zl22Y4uCi4L9X/qJG57Zn71ZzP3oHtDSRgpiIms6g3Y7cEJvF7K/rCw11q92Q==";
      };
    };
    "tree-sitter-bash-0.13.2" = {
      ...
      version = "0.13.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/tree-sitter-bash/-/tree-sitter-bash-0.13.2.tgz";
        sha512 = "6viPvaHwTLRVYLeUXyCSvu+ybLAOVDbkqhvNcp5Ak+GQMqzkflpsuuVIIriyl2lSumrkbUShHnrWiQw4yoZl4g==";
      };
    };
    "tunnel-agent-0.6.0" = {
      name = "tunnel-agent";
    ...
    "whatwg-encoding-1.0.4" = {
      ...
      src = fetchurl {
        ...
        sha512 = "vM9KWN6MP2mIHZ86ytcyIv7e8Cj3KTfO2nd2c8PFDqcI4bxFmQp83ibq4wadq7rL9l9sZV6o9B0LTt8ygGAAXg==";
      };
    };
...
in
{
  bash-language-server = nodeEnv.buildNodePackage {
    ...
    version = "1.5.2";
    src = fetchurl {
      url = "https://registry.npmjs.org/bash-language-server/-/bash-language-server-1.5.2.tgz";
      sha512 = "2ZqjgtxEOReyG5lOcENyLN2mhJrd8VMvmIEAjo9FxEfs8as3UY9LBQ3ypIMnzUc+FGdPkDrf4IAikg+3H6Vd3Q==";
    };
    dependencies = [
      sources."abab-2.0.0"
      sources."acorn-5.7.3"
      ...
      sources."pn-1.1.0"
      sources."prebuild-install-5.1.0"
      ...
      sources."tree-sitter-0.13.15"
      sources."tree-sitter-bash-0.13.2"
      ...
      sources."whatwg-encoding-1.0.4"
      sources."whatwg-mimetype-2.2.0"
