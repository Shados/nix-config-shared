...
let
  sources = {
    ...
    "@types/node-9.6.32" = {
      ...
      version = "9.6.32";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-9.6.32.tgz";
        sha512 = "5+L3wQ+FHoQ589EaH6rYICleuj8gnunq+1CJkM9fxklirErIOv+kxm3s/vecYnpJOYnFowE5uUizcb3hgjHUug==";
      };
    };
    "@types/yargs-10.0.2" = {
      ...
      version = "10.0.2";
      src = fetchurl {
        url = "http://registry.npmjs.org/@types/yargs/-/yargs-10.0.2.tgz";
